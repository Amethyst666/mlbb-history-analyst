...
class GameData {
  ...
  static const List<GameEntity> spells = [
    ...
    GameEntity(id: 20160, assetName: 'arrival', en: 'Arrival', ru: 'Прибытие'),
    GameEntity(
      id: 20190,
      assetName: 'vengeance',
      en: 'Vengeance',
  ...
  static const List<GameEntity> heroes = [
    ...
    GameEntity(id: 52, assetName: 'pharsa', en: 'Pharsa', ru: 'Фаша'),
    // 2018
    ...
    GameEntity(id: 85, assetName: 'dyrroth', en: 'Dyrroth', ru: 'Дариус'),
    ...
    GameEntity(
      id: 94,
      assetName: 'popol_kupa',
      en: 'Popol and Kupa',
      ru: 'Пополь и Купа',
    ),
    GameEntity(id: 95, assetName: 'yu_zhong', en: 'Yu Zhong', ru: 'Чонг'),
    ...
    GameEntity(id: 99, assetName: 'barats', en: 'Barats', ru: 'Бартс'),
    ...
    GameEntity(id: 125, assetName: 'zhuxin', en: 'Zhuxin', ru: 'Чжусинь'),
  ...
  static const List<GameEntity> blessings = [
    ...
    GameEntity(
      id: 20001,
      assetName: 'flame_retribution',
      en: 'Flame Retribution',
      ru: 'Пламенное Возмездие',
      category: 'jungle',
    ),
    GameEntity(
      id: 20002,
      assetName: 'ice_retribution',
      en: 'Ice Retribution',
      ru: 'Ледяное Возмездие',
      category: 'jungle',
    ),
    GameEntity(
      id: 20003,
      assetName: 'bloody_retribution',
      en: 'Bloody Retribution',
      ru: 'Кровавое Возмездие',
      category: 'jungle',
    ),
    // Roam
    GameEntity(
  ...
  static const List<GameEntity> items = [
    ...
    GameEntity(
      id: 2032,
      assetName: 'expert_gloves',
      en: 'Expert Gloves',
      ru: 'Перчатки эксперта',
      category: 'physical',
      tier: 1,
    ),
    GameEntity(
    ...
    GameEntity(
      id: 2029,
      assetName: 'iron_hunting_bow',
      en: 'Iron Hunting Bow',
      ru: 'Железный лук охотника',
      category: 'physical',
      tier: 2,
    ),
    GameEntity(
      id: 4050,
      assetName: 'ogre_tomahawk',
      en: 'Ogre Tomahawk',
      ru: 'Топор великана',
      category: 'physical',
      tier: 2,
    ...
    GameEntity(
      id: 2031,
      assetName: 'rogue_meteor',
      en: 'Rogue Meteor',
      ru: 'Кистень грабителя',
      category: 'physical',
      tier: 2,
    ),
    GameEntity(
      id: 4053,
      assetName: 'magic_blade',
      en: 'Magic Blade',
      ru: 'Магический клинок',
      category: 'physical',
      tier: 2,
    ),
    ...
    GameEntity(
      id: 6079,
      assetName: 'blade_of_heptaseas',
      en: 'Blade of the Heptaseas',
      ru: 'Клинок семи морей',
      category: 'physical',
    ),
    GameEntity(
      id: 4059,
      assetName: 'wind_of_nature',
      en: 'Wind of Nature',
      ru: 'Ветер природы',
      category: 'physical',
    ),
    ...
    GameEntity(
      id: 4054,
      assetName: 'demon_hunter_sword',
      en: 'Demon Hunter Sword',
      ru: 'Меч охотника на демонов',
      category: 'physical',
    ),
    GameEntity(
      id: 4057,
      assetName: 'golden_staff',
      en: 'Golden Staff',
      ru: 'Золотой посох',
      category: 'physical',
    ),
    ...
    GameEntity(
      id: 6086,
      assetName: 'great_dragon_spear',
      en: 'Great Dragon Spear',
      ru: 'Копье Великого дракона',
      category: 'physical',
    ),
    GameEntity(
      id: 4062,
      assetName: 'sky_piercer',
      en: 'Sky Piercer',
      ru: 'Пронзающий небеса',
      category: 'physical',
    ),
    GameEntity(
      id: 6087,
      assetName: 'malefic_gun',
      en: 'Malefic Gun',
      ru: 'Губительный пулемет',
      category: 'physical',
    ),
    ...
    GameEntity(
      id: 4281,
      assetName: 'elegant_gem',
      en: 'Elegant Gem',
      ru: 'Элегантный самоцвет',
      category: 'magic',
      tier: 2,
    ),
    GameEntity(
      id: 4279,
      assetName: 'azure_blade',
      en: 'Azure Blade',
      ru: 'Лазурный Клинок',
      category: 'magic',
      tier: 2,
    ...
    GameEntity(
      id: 6310,
      assetName: 'lightning_truncheon',
      en: 'Lightning Truncheon',
      ru: 'Жезл Молний',
      category: 'magic',
    ),
    GameEntity(
      id: 6309,
      assetName: 'fleeting_time',
      en: 'Fleeting Time',
      ru: 'Мимолетное Время',
      category: 'magic',
    ),
    ...
    GameEntity(
      id: 6306,
      assetName: 'starlium_scythe',
      en: 'Starlium Scythe',
      ru: 'Старлиумовая коса',
      category: 'magic',
    ),
    GameEntity(
      id: 6305,
      assetName: 'glowing_wand',
      en: 'Glowing Wand',
      ru: 'Пылающий Жезл',
      category: 'magic',
    ),
    GameEntity(
      id: 6304,
      assetName: 'ice_queen_wand',
      en: 'Ice Queen Wand',
      ru: 'Жезл Снежной Королевы',
      category: 'magic',
    ),
    GameEntity(
      id: 6303,
      assetName: 'concentrated_energy',
      en: 'Concentrated Energy',
      ru: 'Концентрированная Энергия',
      category: 'magic',
    ),
    GameEntity(
      id: 6302,
      assetName: 'holy_crystal',
      en: 'Holy Crystal',
      ru: 'Священный кристалл',
      category: 'magic',
    ),
    GameEntity(
      id: 6301,
      assetName: 'divine_glaive',
      en: 'Divine Glaive',
      ru: 'Божественный меч',
      category: 'magic',
    ),
    ...
    GameEntity(
      id: 4282,
      assetName: 'enchanted_talisman',
      en: 'Enchanted Talisman',
      ru: 'Зачарованный талисман',
      category: 'magic',
    ),
    GameEntity(
      id: 4284,
      assetName: 'feather_of_heaven',
      en: 'Feather of Heaven',
      ru: 'Райское перо',
      category: 'magic',
    ),
    GameEntity(
      id: 4288,
      assetName: 'wishing_lantern',
      en: 'Wishing Lantern',
      ru: 'Фонарь желаний',
      category: 'magic',
    ),
    GameEntity(
      id: 6312,
      assetName: 'flask_of_the_oasis',
      en: 'Flask of the Oasis',
      ru: 'Фляга оазиса',
      category: 'magic',
    ),
    ...
    GameEntity(
      id: 2481,
      assetName: 'vitality_crystal',
      en: 'Vitality Crystal',
      ru: 'Кристалл здоровья',
      category: 'defense',
      tier: 1,
    ),
    GameEntity(
      id: 2482,
      assetName: 'leather_jerkin',
      en: 'Leather Jerkin',
      ru: 'Кожаная броня',
      category: 'defense',
      tier: 1,
    ...
    GameEntity(
      id: 2483,
      assetName: 'magic_resist_cloak',
      en: 'Magic Resist Cloak',
      ru: 'Плащ сопротивления магии',
      category: 'defense',
      tier: 1,
    ),
    ...
    GameEntity(
      id: 4506,
      assetName: 'molten_essence',
      en: 'Molten Essence',
      ru: 'Расплавленная субстанция',
      category: 'defense',
      tier: 2,
    ),
    GameEntity(
      id: 4508,
      assetName: 'black_ice_shield',
      en: 'Black Ice Shield',
      ru: 'Щит из черного льда',
      category: 'defense',
      tier: 2,
    ),
    GameEntity(
      id: 4509,
      assetName: 'dreadnaught_armor',
      en: 'Dreadnaught Armor',
      ru: 'Броня неустрашимости',
      category: 'defense',
      tier: 2,
    ),
    GameEntity(
      id: 4507,
      assetName: 'silence_robe',
      en: 'Silence Robe',
      ru: 'Роба тишины',
      category: 'defense',
      tier: 2,
    ...
    GameEntity(
      id: 4510,
      assetName: 'steel_legplates',
      en: 'Steel Legplates',
      ru: 'Стальные кожаные латы',
      category: 'defense',
      tier: 2,
    ),
    GameEntity(
      id: 2485,
      assetName: 'heros_ring',
      en: 'Hero\'s Ring',
      ru: 'Кольцо Героя',
      category: 'defense',
      tier: 2,
    ...
    GameEntity(
      id: 6540,
      assetName: 'chastise_pauldron',
      en: 'Chastise Pauldron',
      ru: 'Наплечники наказания',
      category: 'defense',
      tier: 3,
    ),
    GameEntity(
      id: 6538,
      assetName: 'radiant_armor',
      en: 'Radiant Armor',
      ru: 'Сияющая Броня',
      category: 'defense',
    ),
    GameEntity(
      id: 6536,
      assetName: 'brute_force_breastplate',
      en: 'Brute Force Breastplate',
      ru: 'Кираса Грубой Силы',
      category: 'defense',
    ),
    GameEntity(
      id: 6535,
      assetName: 'immortality',
      en: 'Immortality',
      ru: 'Бессмертие',
      category: 'defense',
    ),
    ...
    GameEntity(
      id: 4736,
      assetName: 'arcane_boots',
      en: 'Arcane Boots',
      ru: 'Сапоги Заклинателя',
      category: 'movement',
    ),
    GameEntity(
      id: 4737,
      assetName: 'swift_boots',
      en: 'Swift Boots',
      ru: 'Сапоги Спешки',
      category: 'movement',
    ),
    ...
    GameEntity(
      id: 6868,
      assetName: 'warrior_boots',
      en: 'Warrior Boots (Flame)',
      ru: 'Сапоги Воина (Пламя)',
      category: 'movement',
      blessingId: 20001,
    ),
    GameEntity(
    ...
    GameEntity(
      id: 6869,
      assetName: 'warrior_boots',
      en: 'Warrior Boots (Bloody)',
      ru: 'Сапоги Воина (Кровь)',
      category: 'movement',
      blessingId: 20003,
    ),
    GameEntity(
      id: 7095,
      assetName: 'warrior_boots',
      en: 'Warrior Boots (Conceal)',
      ru: 'Сапоги Воина (Маскировка)',
      category: 'movement',
      blessingId: 20004,
    ),
    GameEntity(
      id: 7096,
      assetName: 'warrior_boots',
      en: 'Warrior Boots (Encourage)',
      ru: 'Сапоги Воина (Поощрение)',
      category: 'movement',
      blessingId: 20005,
    ),
    GameEntity(
      id: 7097,
      assetName: 'warrior_boots',
      en: 'Warrior Boots (Favor)',
      ru: 'Сапоги Воина (Благосклонность)',
      category: 'movement',
      blessingId: 20006,
    ),
    GameEntity(
      id: 7098,
      assetName: 'warrior_boots',
      en: 'Warrior Boots (Dire Hit)',
      ru: 'Сапоги Воина (Острый Удар)',
      category: 'movement',
      blessingId: 20007,
    ),
    // Tough Boots (4003)
    GameEntity(
      id: 6878,
      assetName: 'tough_boots',
      en: 'Tough Boots (Flame)',
      ru: 'Прочные Сапоги (Пламя)',
      category: 'movement',
      blessingId: 20001,
    ),
    GameEntity(
    ...
    GameEntity(
      id: 6879,
      assetName: 'tough_boots',
      en: 'Tough Boots (Bloody)',
      ru: 'Прочные Сапоги (Кровь)',
      category: 'movement',
      blessingId: 20003,
    ),
    GameEntity(
      id: 7105,
      assetName: 'tough_boots',
      en: 'Tough Boots (Conceal)',
      ru: 'Прочные Сапоги (Маскировка)',
      category: 'movement',
      blessingId: 20004,
    ),
    GameEntity(
      id: 7106,
      assetName: 'tough_boots',
      en: 'Tough Boots (Encourage)',
      ru: 'Прочные Сапоги (Поощрение)',
      category: 'movement',
      blessingId: 20005,
    ),
    GameEntity(
      id: 7107,
      assetName: 'tough_boots',
      en: 'Tough Boots (Favor)',
      ru: 'Прочные Сапоги (Благосклонность)',
      category: 'movement',
      blessingId: 20006,
    ),
    GameEntity(
      id: 7108,
      assetName: 'tough_boots',
      en: 'Tough Boots (Dire Hit)',
      ru: 'Прочные Сапоги (Острый Удар)',
      category: 'movement',
      blessingId: 20007,
    ),
    // Magic Shoes (4004)
    GameEntity(
      id: 6888,
      assetName: 'magic_shoes',
      en: 'Magic Shoes (Flame)',
      ru: 'Магические Сапоги (Пламя)',
      category: 'movement',
      blessingId: 20001,
    ),
    GameEntity(
    ...
    GameEntity(
      id: 6889,
      assetName: 'magic_shoes',
      en: 'Magic Shoes (Bloody)',
      ru: 'Магические Сапоги (Кровь)',
      category: 'movement',
      blessingId: 20003,
    ),
    GameEntity(
      id: 7115,
      assetName: 'magic_shoes',
      en: 'Magic Shoes (Conceal)',
      ru: 'Магические Сапоги (Маскировка)',
      category: 'movement',
      blessingId: 20004,
    ),
    GameEntity(
      id: 7116,
      assetName: 'magic_shoes',
      en: 'Magic Shoes (Encourage)',
      ru: 'Магические Сапоги (Поощрение)',
      category: 'movement',
      blessingId: 20005,
    ),
    GameEntity(
      id: 7117,
      assetName: 'magic_shoes',
      en: 'Magic Shoes (Favor)',
      ru: 'Магические Сапоги (Благосклонность)',
      category: 'movement',
      blessingId: 20006,
    ),
    GameEntity(
      id: 7118,
      assetName: 'magic_shoes',
      en: 'Magic Shoes (Dire Hit)',
      ru: 'Магические Сапоги (Острый Удар)',
      category: 'movement',
      blessingId: 20007,
    ),
    // Arcane Boots (4005)
    GameEntity(
      id: 6898,
      assetName: 'arcane_boots',
      en: 'Arcane Boots (Flame)',
      ru: 'Сапоги Заклинателя (Пламя)',
      category: 'movement',
      blessingId: 20001,
    ),
    GameEntity(
    ...
    GameEntity(
      id: 6899,
      assetName: 'arcane_boots',
      en: 'Arcane Boots (Bloody)',
      ru: 'Сапоги Заклинателя (Кровь)',
      category: 'movement',
      blessingId: 20003,
    ),
    GameEntity(
      id: 7125,
      assetName: 'arcane_boots',
      en: 'Arcane Boots (Conceal)',
      ru: 'Сапоги Заклинателя (Маскировка)',
      category: 'movement',
      blessingId: 20004,
    ),
    GameEntity(
      id: 7126,
      assetName: 'arcane_boots',
      en: 'Arcane Boots (Encourage)',
      ru: 'Сапоги Заклинателя (Поощрение)',
      category: 'movement',
      blessingId: 20005,
    ),
    GameEntity(
      id: 7127,
      assetName: 'arcane_boots',
      en: 'Arcane Boots (Favor)',
      ru: 'Сапоги Заклинателя (Благосклонность)',
      category: 'movement',
      blessingId: 20006,
    ),
    GameEntity(
      id: 7128,
      assetName: 'arcane_boots',
      en: 'Arcane Boots (Dire Hit)',
      ru: 'Сапоги Заклинателя (Острый Удар)',
      category: 'movement',
      blessingId: 20007,
    ),
    // Swift Boots (4006)
    GameEntity(
      id: 6908,
      assetName: 'swift_boots',
      en: 'Swift Boots (Flame)',
      ru: 'Сапоги Спешки (Пламя)',
      category: 'movement',
      blessingId: 20001,
    ),
    GameEntity(
    ...
    GameEntity(
      id: 6909,
      assetName: 'swift_boots',
      en: 'Swift Boots (Bloody)',
      ru: 'Сапоги Спешки (Кровь)',
      category: 'movement',
      blessingId: 20003,
    ),
    GameEntity(
      id: 7135,
      assetName: 'swift_boots',
      en: 'Swift Boots (Conceal)',
      ru: 'Сапоги Спешки (Маскировка)',
      category: 'movement',
      blessingId: 20004,
    ),
    GameEntity(
      id: 7136,
      assetName: 'swift_boots',
      en: 'Swift Boots (Encourage)',
      ru: 'Сапоги Спешки (Поощрение)',
      category: 'movement',
      blessingId: 20005,
    ),
    GameEntity(
      id: 7137,
      assetName: 'swift_boots',
      en: 'Swift Boots (Favor)',
      ru: 'Сапоги Спешки (Благосклонность)',
      category: 'movement',
      blessingId: 20006,
    ),
    GameEntity(
      id: 7138,
      assetName: 'swift_boots',
      en: 'Swift Boots (Dire Hit)',
      ru: 'Сапоги Спешки (Острый Удар)',
      category: 'movement',
      blessingId: 20007,
    ),
    // Demon Shoes (4007)
    GameEntity(
      id: 6868,
      assetName: 'demon_shoes',
      en: 'Demon Shoes (Flame)',
      ru: 'Обувь Демона (Пламя)',
      category: 'movement',
      blessingId: 20001,
    ),
    GameEntity(
    ...
    GameEntity(
      id: 6869,
      assetName: 'demon_shoes',
      en: 'Demon Shoes (Bloody)',
      ru: 'Обувь Демона (Кровь)',
      category: 'movement',
      blessingId: 20003,
    ),
    GameEntity(
      id: 7155,
      assetName: 'demon_shoes',
      en: 'Demon Shoes (Conceal)',
      ru: 'Обувь Демона (Маскировка)',
      category: 'movement',
      blessingId: 20004,
    ),
    GameEntity(
      id: 7156,
      assetName: 'demon_shoes',
      en: 'Demon Shoes (Encourage)',
      ru: 'Обувь Демона (Поощрение)',
      category: 'movement',
      blessingId: 20005,
    ),
    GameEntity(
      id: 7157,
      assetName: 'demon_shoes',
      en: 'Demon Shoes (Favor)',
      ru: 'Обувь Демона (Благосклонность)',
      category: 'movement',
      blessingId: 20006,
    ),
    GameEntity(
      id: 7158,
      assetName: 'demon_shoes',
      en: 'Demon Shoes (Dire Hit)',
      ru: 'Обувь Демона (Острый Удар)',
      category: 'movement',
      blessingId: 20007,
    ),
    // Rapid Boots (4008)
    GameEntity(
      id: 7046,
      assetName: 'rapid_boots',
      en: 'Rapid Boots (Flame)',
      ru: 'Сапоги-Скороходы (Пламя)',
      category: 'movement',
      blessingId: 20001,
    ),
    GameEntity(
    ...
    GameEntity(
      id: 7047,
      assetName: 'rapid_boots',
      en: 'Rapid Boots (Bloody)',
      ru: 'Сапоги-Скороходы (Кровь)',
      category: 'movement',
      blessingId: 20003,
    ),
    GameEntity(
      id: 7145,
      assetName: 'rapid_boots',
      en: 'Rapid Boots (Conceal)',
      ru: 'Сапоги-Скороходы (Маскировка)',
      category: 'movement',
      blessingId: 20004,
    ),
    GameEntity(
      id: 7146,
      assetName: 'rapid_boots',
      en: 'Rapid Boots (Encourage)',
      ru: 'Сапоги-Скороходы (Поощрение)',
      category: 'movement',
      blessingId: 20005,
    ),
    GameEntity(
      id: 7147,
      assetName: 'rapid_boots',
      en: 'Rapid Boots (Favor)',
      ru: 'Сапоги-Скороходы (Благосклонность)',
      category: 'movement',
      blessingId: 20006,
    ),
    GameEntity(
      id: 7148,
      assetName: 'rapid_boots',
      en: 'Rapid Boots (Dire Hit)',
      ru: 'Сапоги-Скороходы (Острый Удар)',
      category: 'movement',
      blessingId: 20007,
    ),
  ...
  static GameEntity? getHero(int id) {
    try {
      return heroes.firstWhere((e) => e.id == id);
    } catch (_) {
      return null;
    }
  }
  ...
  static GameEntity? getBlessing(int id) {
    try {
      return blessings.firstWhere((e) => e.id == id);
    } catch (_) {
      return null;
  ...
  static int getHeroIdByAssetName(String assetName) {
    try {
      return heroes.firstWhere((e) => e.assetName == assetName).id;
    } catch (_) {
      return 0;
    }
  }
  ...
  static int getItemIdByAssetName(String assetName) {
    try {
      return items.firstWhere((e) => e.assetName == assetName).id;
    } catch (_) {
      return 0;
    }
  }
  ...
  static int getSpellIdByAssetName(String assetName) {
    try {
      return spells.firstWhere((e) => e.assetName == assetName).id;
    } catch (_) {
      return 0;
    }
  }
